...
public class BaseInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object o) throws Exception {
        ...
        if (uri.startsWith("/adminlogin_king") && !uri.startsWith("/adminlogin_king/login") && null == user
                && !uri.startsWith("/adminlogin_king/css") && !uri.startsWith("/adminlogin_king/images")
                && !uri.startsWith("/admin/js") && !uri.startsWith("/adminlogin_king/plugins")
                && !uri.startsWith("/adminlogin_king/editormd")) {
            response.sendRedirect(request.getContextPath() + "/adminlogin_king/login");
            return false;
        }
